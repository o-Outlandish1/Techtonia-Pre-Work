var emptyVariable = '';
    ...
    num2 = 9; //value of greater than or equal to 1 and less than or equal to 10

//Question:
//What numbers would be valid values for num2 but not num1?
//Answer:
//num1 is exclusive of 1 and 10, while num2 is inclusive of 1 and 10. So, 1 and 10 would be valid values for num2 but not num1.
...
var myName = 'Robyn';
    dreamDestination = 'Berlin';
	part1 = 'Hi my name is' + ' ' + myName + ' ';
    part2 = 'and I can\'t wait to visit' + ' ' + dreamDestination + '!';
    statement = part1.concat(part2);
...
var myAnswerForExercise12 = 'whitespace';
